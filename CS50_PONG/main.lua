...
function love.load()
    ...
    player2 = Paddle(VIRTUAL_WIDTH - 15, VIRTUAL_HEIGHT - 30 - 30, 5, 30)
...
function love.update(dt)
    ...
    elseif gameState == 'play' then
        ...
        -- Right Paddle AI Implementation
        if ball.y >= player2.y + 5 and ball.y + 4 <= player2.y + 25 then
            player2.dy = 0 
        else
            if player2.y + 5 > ball.y then
                player2.dy = -AI_TEMPO
            elseif player2.y + 25 < ball.y + 4 then
                player2.dy = AI_TEMPO
            end
        end    
